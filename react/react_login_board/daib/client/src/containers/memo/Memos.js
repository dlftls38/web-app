...
import { MemoWrite, MemoList } from '../../components';
import {
    memoPostRequest,
    memoListRequest,
    memoEditRequest,
...
import { searchMemoAccountRequest } from '../../actions/search/search';
...
class Memos extends React.Component {
    ...
    loadOldMemo() {
        ...
        if(this.props.memoData.length===0){
            ...
            lastId = this.props.memoData[this.props.memoData.length - 1]._id;
        }
    ...
    handleSearch(keyword) {
        this.props.searchMemoAccountRequest(keyword);
    }
    ...
    render() {
        ...
        const wallHeader = (
            <div>
                <div className="container wall-info">
                    <div className="card wall-info black lighten-2 white-text">
        ...
        // console.log(this.props.username, this.props.currentUser, this.props.username===this.props.currentUser, !this.props.username, (this.props.username===this.props.currentUser || !this.props.username));
        return (
            <div>
                <div><MemoSearch 
                ...
                <div className="wrapper">
                    ...
                    {this.props.isLoggedIn && (this.props.username===this.props.currentUser || !this.props.username) ? <MemoWrite onPost={this.handlePost}/> : undefined}
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        searchMemoAccountRequest: (keyword) => {
            return dispatch(searchMemoAccountRequest(keyword));
        }
    };
};
